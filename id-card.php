                             ...
                             $html.="
                                        ...
                                        <div class='container' style='text-align:left; border:2px dotted black;'>
                                              ...
                                              <div class='container-2'>
                                                  ...
                                                  <div class='box-2'>
                                                      <h2>$name</h2>
                                                      <p style='font-size: 14px; color: black'>Mysql Developer</p>
                                                  </div>
                                                  <div class='box-3'>
                                              ...
                                              <div class='container-3'>
                                                  ...
                                                  <div class='info-4'>
                                                      <div class='sign'>
                                                        ...
                                                        <p style='font-family: Dancing Script'>Kartexa</p>
...
.header {
    ...
    margin: 20px auto;
    background-color: white;
    background-image: url(img/Code_Camp_BD.png);
    overflow: hidden;
...
<div style="padding-top: 10px;">
                <marquee onMouseOver="this.stop()" onMouseOut="this.start()"> Kartexa is the sole owner of this script. </marquee>
            </div>
  <br>
    ...
    function downloadtable() {
        ...
        domtoimage.toPng(node)
            .then(function (dataUrl) {
                var img = new Image();
                img.src = dataUrl;
                downloadURI(dataUrl, "kartexa-id-card.png")
            })
